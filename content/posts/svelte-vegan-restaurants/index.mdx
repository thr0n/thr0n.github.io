...
With a simple `GET` request, I can then retrieve the coordinates together with other restaurant data and show them in the frontend 🗺.
...
However, I did recognise a few highlights from Svelte.
